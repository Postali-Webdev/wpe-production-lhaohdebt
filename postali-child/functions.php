 ...
 */
	...
	function postali_child() {
		...
		//wp_register_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Libre+Baskerville&family=Outfit:wght@300;700;&display=swap" rel="stylesheet', array() );
		wp_register_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Outfit:wght@300;700&display=swap', array(), time(), true );
		wp_enqueue_style('google-fonts');

        wp_register_style( 'icomoon-fonts', 'https://cdn.icomoon.io/152819/LHAOhioDebtIcons/style-cf.css?i2bd8o', array() );
        ...
        wp_register_script('webp-scripts', get_stylesheet_directory_uri() . '/assets/js/modernizr-webp.js',array('jquery'), null, true); 
		wp_enqueue_script('webp-scripts');
        ...
        //waypoints
        wp_register_script('practice-area-parent', get_stylesheet_directory_uri() . '/assets/js/practice-area-parent.min.js', array('jquery'));
		wp_enqueue_script('practice-area-parent');
        ...
        // tabs
        wp_register_script('contact-us', get_stylesheet_directory_uri() . '/assets/js/contact.min.js',array('jquery'), null, true); 
    ...
    // create shortcode for embedding global phone number in wysiwyg
    function addGlobalNumber() {
        return get_field('global_phone','options');
    }
    add_shortcode('globalnumber', 'addGlobalNumber');
